        ...
        <div class="login_box">
          ...
          >
            ...
            <el-form-item class="btns">
              ...
              <el-button type="primary" round style="width: 300px" @click="Yz"
                >登录</el-button
              >
            </el-form-item>
  ...
  methods: {
    ...
    async logins() {
      ...
      window.sessionStorage.setItem(
        "token",
        "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1aWQiOjUwMCwicmlkIjowLCJpYXQiOjE2MjA0NDEyMTcsImV4cCI6MTYyMDUyNzYxN30.WvpKNP0-uZP4FRjWfCQVnI-yVrGUvQN4L1ezABtT3hk"
      );
