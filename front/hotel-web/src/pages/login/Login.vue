        ...
        <div class="login_box">
          ...
          >
            ...
            <el-form-item class="btns">
              ...
              <el-button type="primary"  round style="width:300px" @click="Yz">登录</el-button>
            </el-form-item>
...
export default {
  ...
  methods: {
    ...
    // this.$message({  type: 'error',   message: "555555" })
    window.sessionStorage.setItem('token',"Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1aWQiOjUwMCwicmlkIjowLCJpYXQiOjE2MTk0MzE2MjAsImV4cCI6MTYxOTUxODAyMH0.aHP1QDIP6rZkwCl9XI6WMPS1Rfw-AgCbHmxhI8m9iW0")
    //通过编程式导航跳转到首页   路由是/home
    this.$router.push("/")
